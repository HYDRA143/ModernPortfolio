          ...
          <div className="sobre-mi-container">
            ...
            <div className="sobre-mi-info">
              <p>
                <FormattedMessage
                  id="about-info-1"
                  defaultMessage={`Hi, I'm ${PROFILE_NAME}, a full-stack developer passionate about programming and web development. Since 2020, I have been building projects across the frontend and backend, and I still bring that same curiosity and discipline to every product I work on.`}
                />
              </p>

              <div
                className={
                  isExpanded ? "parrafo-active show" : "hide parrafo-active"
                }
              >
                <p>
                  <FormattedMessage
